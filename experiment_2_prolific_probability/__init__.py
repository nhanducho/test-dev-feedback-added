...
class C(BaseConstants):
    NAME_IN_URL = 'experiment_2_prolific_probability'
    ...
    COMP_QUESTIONS_MC = [
        ...
        {
            'question': 'How much Gross profit do you earn in a round?',
            'options': [
                {'text': '1000 ECU'},
        ...
        {
            'question': 'What is the Probability of disruptions when your spending is 0 ECU?',
            'options': [
        ...
        {
            'question': 'What is the Loss caused by a disruption when your SC resilience spending is 0 ECU?',
            'options': [
                {'text': '1000 ECU'},
                {'text': '500 ECU', 'correct': True},
                {'text': '100 ECU'}
            ]
        },
        {
            'question': 'What is your Net profit when you spend 20 ECU and no disruption occurs?',
            'options': [
        ...
        {
            'question': 'What is the Probability of disruptions when your Spending is 100 ECU?',
            'options': [
                {'text': '5%'},
                {'text': '0%', 'correct': True},
                {'text': '10%'}
        ...
        {
            'question': 'What is the Loss caused by a disruption when your SC resilience spending is 50 ECU?',
            'options': [
                {'text': '250 ECU'},
                {'text': '50 ECU'},
                {'text': '500 ECU', 'correct': True}
    ...
    COMP_QUESTIONS_TF = [
        {
            'question': 'You can decide to spend freely between 0 and 100.',
            'options': [
        ...
        {
            'question': 'After spending 50 ECU, you can still be at risk of disruptions.',
            'options': [
                {'text': 'True', 'correct': True},
                {'text': 'False'}
            ]
...
class Player(BasePlayer):
    ...
    scr_importance = models.IntegerField(
        label="Please indicate the extent to which you think Supply Chain Resilience is important nowadays?",
...
class GamePage(Page):
    ...
    def live_method(player: Player, data):
        ...
        if 'action' in data and data['action'] == 'calculate_result':
            ...
            disruption_impact = C.DISRUPTION_COST
