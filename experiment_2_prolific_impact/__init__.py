...
class C(BaseConstants):
    NAME_IN_URL = 'experiment_2_prolific_impact'
    ...
    COMP_QUESTIONS_MC = [
        ...
        {
            'question': 'What is the Probability of disruptions when your Spending is 50 ECU?',
            'options': [
        ...
        {
            'question': 'What is the Loss caused by a disruption when your Spending is 0 ECU?',
            'options': [
                {'text': '1000 ECU'},
        ...
        {
            'question': 'What is the Loss caused by a disruption when your Spending is 100 ECU?',
            'options': [
                {'text': '200 ECU'},
                {'text': '100 ECU'},
    ...
    COMP_QUESTIONS_TF = [
        ...
        {
            'question': 'After spending 50 ECU on SC resilience, you can still be at risk of disruptions.',
            'options': [
                {'text': 'True', 'correct': True},
                {'text': 'False'}
            ]
...
class GamePage(Page):
    ...
    def live_method(player: Player, data):
        ...
        if 'action' in data and data['action'] == 'calculate_result':
            ...
            disruption_probability = C.BASIC_PROBABILITY
